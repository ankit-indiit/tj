...
<div class="main_content order-his oredr-pag">
 ...
 </h2>  <div class="filter-select pull-right d-inline m-all">
     <div class="dropdown">
...
<div class="full-w">
                    ...
                    <div class="job-detai ">
                                <div class="main-head">
                                <div class="row">
                                  <div class="col-sm-2"><h3>ORDER PLACED</h3>
                                  <h6>16 july 2021</h6></div>  
                                  <div class="col-sm-6"><h3>TOTAL</h3>  <h6>$ 6.99</h6></div>  
                                  
                                      <div class="col-sm-4 text-right"><h3>ORDER #DFR-4546567677</h3> <h6><a href="">View order details</a> <a href="">Invoice</a></h6></div>
                                </div>
                                    </div> 
                                    <div class="maind-bgf">
                                      <div class="row">
                                ...
                                <a href="job-details.html" class="job-logo">
                                   <img src="assets/images/tshrt.png" alt="">
                                </a>
                ...
                <div class="">  <h3>  White  Embroidered  T-shirt</h3>
                <h4>Forever 21</h4>
                                    <!--h4>#3435456 </h4-->
...
<a class="filters" href="order-history-details.html" aria-expanded="false">
...
<a class="filters" href="order-history-details.html" aria-expanded="false">
 ...
 <div class="job-detai ">
                ...
                <div class="">  <h3>  V Neck Floral A Line Dress - Grey
</h3>
                <h4>Forever 21</h4>
                                    <!--h4>#3435456 </h4-->
