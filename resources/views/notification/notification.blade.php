                  ...
                  <li>
                      <div class="flex items-start space-x-5 p-7 my-4">
                         ...
                         <div class="flex-1">
                            ...
                            @if (getUserById($friend)->user_friendship_status == 'pending')
                              <div class="my-1 followBackBtnSec">
                                <a href="javascript:void(0);" id="followBack" data-id="{{$notification->data['data']['friendshipId']}}" data-user-id="{{$notification->data['data']['sender_id']}}" data-notification-id="{{$notification->id}}" class="btn btn-primary btn-sm">Follow back</a>
                                <a href="javascript:void(0);" id="deleteSenderRequest" data-id="{{$notification->data['data']['friendshipId']}}" data-notification-id="{{$notification->id}}" class="btn btn-secondary btn-sm">Delete</a>
                              </div>                            
                            @endif
                         </div>
                      </div>
