      ...
      <div class="flex justify-between relative md:mb-4 mb-3">
         <div class="flex-1">
            ...
            <nav class="responsive-nav border-b md:m-0 -mx-4">
               <ul>
                  <li class="active">
                     <a href="{{ route('seller.shop', 'suggestion') }}" class="lg:px-2"> Suggestions </a>
                  </li>
                  <li>
                     <a href="{{ route('seller.shop', 'newest') }}" class="lg:px-2"> Newest </a>
                  </li>
                  <li>
                     <a href="{{ route('seller.shop', 'my_shop') }}" class="lg:px-2"> My Shops </a>
                  </li>
               </ul>
            </nav>
         </div>
