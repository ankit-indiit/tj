        ...
        <div class="{{ hideFeedThingFromTimeLine() }}">
            ...
            <div class="bg-white w-56 shadow-md mx-auto p-2 mt-12 rounded-md text-gray-500 hidden text-base border border-gray-100 dark:bg-gray-900 dark:text-gray-100 dark:border-gray-700 uk-drop" uk-drop="mode: click;pos: bottom-right;animation: uk-animation-slide-bottom-small">
                <ul class="space-y-1">
                    ...
                    <li>
                        <a href="#" class="flex items-center px-3 py-2 hover:bg-gray-200 hover:text-gray-800 rounded-md dark:hover:bg-gray-800" onclick="updatePost(<?php echo $post->id; ?>);" onchange="ValidateFileUpload('post_image_upload','output_simple_post_image')"> <i class="uil-edit-alt mr-1"></i> Edit Post </a>
                    </li>
                    <li>
                    ...
                    <div class="col-md-6">
                        <a href="{{ url('public/posts/images') }}/{{ $post->video }}">
                            <video class="max-h-96 w-full object-cover" width="320" height="240" controls>
                              <source src="{{ url('public/posts/images') }}/{{ $post->video }}" type="video/ogg">
                            </video>
                        </a>
                    </div>
                </div>
