                        ...
                        <form action="">
                            <div class="input-group mb-3">
                                <div class="input-group-prepend main-div-serch">
                                    ...
                                    <input value="" type="text" class="form-control" placeholder="Search Here.." autocomplete="off">
                    ...
                    <div class="right_side">
                        <div class="header_widgets">
                            ...
                            <div uk-drop="mode: click" class="header_dropdown">
                                    ...
                                    <ul>
                                        <li>
                                            <a href="#">
                                                ...
                                                <div class="drop_text">
                                                    <p>
                                                        <strong>Alex Dolgove</strong> Added New Review In Course <span class="text-link">Full Stack PHP Developer</span>
                                                    </p>
                                        ...
                                        <li>
                                            <a href="#">
                                                ...
                                                <div class="drop_text">
                                                    <p>
                                                        <strong>Jonathan Madano</strong> Shared Your Discussion On Course <span class="text-link">Css Flex Box </span>
                                                    </p>
                                                    <time> Yesterday </time>
                                                </div>
                                            </a>
                                ...
                                <a href="notification.html" class="see-all"> See all Notifications </a>
                            </div>
                            <!-- Message -->
                            <a href="#" class="is_icon">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <div uk-drop="mode: click" class="header_dropdown is_message">
                                ...
                                <a href="chat.html" class="see-all"> See all in Messages</a>
                            </div>
                            <a href="wishlist.html" class="is_icon" aria-expanded="false">
                                <ion-icon name="heart-sharp" class="heart-wish"></ion-icon>
                            </a>
                            <a href="cart.html" class="is_icon" aria-expanded="false">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z"></path>
                                </svg>
                                <span class="cart-main">$3</span>
                            </a>
                            <a href="#">
                                <img src="{{ show_user_image() }}" class="is_avatar user_profile_image" alt="">
                            </a>
                            <div uk-drop="mode: click;offset:5" class="header_dropdown profile_dropdown">
                                <a href="{{ url('my-profile') }}" class="user">
