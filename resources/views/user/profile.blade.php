...
<div class="main_content timeline-page">
   <div class="mcontainer">
            ...
            <div class="flex justify-between lg:border-t flex-col-reverse lg:flex-row">
               <nav class="cd-secondary-nav pl-2 is_ligh -mb-0.5 border-transparent">
                  <ul class="nav nav-tabs" id="myTab" role="tablist">
                     ...
                     <li class="nav-item" role="presentation">
                        <a class="nav-link" id="pics-tab" data-toggle="tab" href="#pics" role="tab" aria-controls="pics" aria-selected="false">Photos</a>
                     </li>                     
                     <li class="nav-item" role="presentation">
            ...
            <div class="flex justify-between lg:border-t flex-col-reverse lg:flex-row">
               <nav class="cd-secondary-nav pl-2 is_ligh -mb-0.5 border-transparent">
                  <ul class="nav nav-tabs" id="myTab" role="tablist">
                     ...
                     <li class="nav-item" role="presentation">
                        <a class="nav-link" id="collec-tab" data-toggle="tab" href="#collec" role="tab" aria-controls="collec" aria-selected="false">Collections</a>
                     </li>
                     <li class="nav-item" role="presentation">
                        <a class="nav-link" id="list-tab" data-toggle="tab" href="#list" role="tab" aria-controls="list" aria-selected="false">Listings</a>
                     </li>
                     <li class="nav-item" role="presentation">
                     ...
                     <li class="nav-item" role="presentation">
                        <a class="nav-link" id="bio-tab" data-toggle="tab" href="#bio" role="tab" aria-controls="bio" aria-selected="false">My Bio</a>
                     </li>
                  </ul>
               </nav>
            </div>
      ...
      <div class="tab-content">
                     ...
                     <div>
                        ...
                        <div class="bg-white w-56 shadow-md mx-auto p-2 mt-12 rounded-md text-gray-500 hidden text-base border border-gray-100 dark:bg-gray-900 dark:text-gray-100 dark:border-gray-700 uk-drop" uk-drop="mode: click;pos: bottom-right;animation: uk-animation-slide-bottom-small">
                           <ul class="space-y-1">
                              ...
                              <li>
                                 <a href="#" class="flex items-center px-3 py-2 text-red-500 hover:bg-red-100 hover:text-red-500 rounded-md dark:hover:bg-red-600"> <i class="uil-trash-alt mr-1"></i> Unfriend </a>
                              </li>
                           </ul>
                        </div>
                     </div>
         ...
         <div class="tab-pane wishlist-page" id="collec" role="tabpanel" aria-labelledby="collec-tab">
            <div class="" style="margin-top: 42px;">
               <div class="row mt-4">
                  <div class="col-sm-12">
               ...
               <div class="">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 mb-4">
                           <div class="card">
                              <div class="card-media h-44">
                                 <div class="card-media-overly"></div>
                                 <img src="{{ asset('images/tshert.png') }}" alt="" />
                                 <div class="main-tools ms" style="display: inline-block;" data-toggle="tooltip" data-placement="top" title="Add to Collection">
                                    <a class="remove" href="#" aria-expanded="false"><i class="icon-feather-more-horizontal"></i> </a>
                                    <div class="bg-white w-56 shadow-md mx-auto p-2 mt-12 rounded-md text-gray-500 hidden text-base border border-gray-100 dark:bg-gray-900 dark:text-gray-100 dark:border-gray-700 uk-drop main-ss uk-drop-bottom-right" uk-drop="mode: click;pos: bottom-right;animation: uk-animation-slide-bottom-small main-ss" style="left: -182px; top: -6px;">
                                       <div class="sidebar_innersss" data-simplebar="init">
                                          <div class="simplebar-wrapper" style="margin: 0px;">
                                             <div class="simplebar-height-auto-observer-wrapper">
                                                <div class="simplebar-height-auto-observer"></div>
                  ...
                  <div class="tab-pane" id="profile-1" role="tabpanel" aria-labelledby="profile-tabz"></div>
               </div>
            </div>
         ...
         <div class="tab-pane mt-5" id="list" role="tabpanel" aria-labelledby="list-tab">
            <div class="flex justify-between relative md:mb-4 mb-3 mt-5 border-b pb-3">
               ...
               <div id="divcheck" style="display: none;">
                  <!--a href="#" class="is_link featured-btn pull-right"> Add to Collections </a-->
                  <div style="display: inline-block;" data-toggle="tooltip" data-placement="top" title="Add to Collection">
                     <a href="#" class="is_link featured-btn pull-right" aria-expanded="false"> Add to Collections </a>
               ...
               <a href="add-product.html" class="is_link featured-btn pull-right"> Add product </a>
